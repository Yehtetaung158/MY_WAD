...
class __TwigTemplate_cb734a0fd39caccb6ef6c2ff4380aeab extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Your preferences will be saved for current session only. Storing them permanently requires %sphpMyAdmin configuration storage%s.");
    ...
    {
        return new Source("", "preferences/header.twig", "C:\\Users\\HUAWEI\\Downloads\\phpMyAdmin-5.2.1-all-languages\\phpMyAdmin-5.2.1-all-languages\\templates\\preferences\\header.twig");
    }
}
