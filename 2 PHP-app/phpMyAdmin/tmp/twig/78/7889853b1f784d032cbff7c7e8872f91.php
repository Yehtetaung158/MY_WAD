...
class __TwigTemplate_547fca2749b048fee5e5ff1aa2a8a6d3 extends Template
{
    private $source;
    private $macros = [];
...
";
            ...
            // line 80
            echo "  ";
            echo $this->env->getFilter('error')->getCallable()(twig_sprintf(_gettext("Not enough privilege to view server variables and settings. %s"), PhpMyAdmin\Html\Generator::linkToVarDocumentation("show_compatibility_56",             // line 81
...
";
    ...
    {
        return new Source("", "server/variables/index.twig", "C:\\Users\\HUAWEI\\Downloads\\phpMyAdmin-5.2.1-all-languages\\phpMyAdmin-5.2.1-all-languages\\templates\\server\\variables\\index.twig");
    }
}
