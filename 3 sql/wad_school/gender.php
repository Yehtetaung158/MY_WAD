            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800"><?= $row['type'] ?></td>

                        <td class="px-6 py-4 text-end whitespace-nowrap text-sm font-medium text-gray-800"><?= $row['student_count'] ?></td>
