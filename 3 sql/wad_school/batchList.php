    ...
    <div class=" w-full flex overflow-auto">
        <table class=" divide-y divide-gray-200 ">
            ...
            <tbody class="divide-y divide-gray-200">
                <?php
                $sql = "SELECT *,batches.id as batch_id,
                (SELECT count(id) FROM enrollments WHERE batches.id=enrollments.batch_id) AS student_count  FROM batches LEFT  JOIN courses ON courses.id= batches.course_id";
                ...
                ?>
                    <tr class="hover:bg-gray-100">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800"><?= $row['student_count'] ?>/<?= $row['student_limit'] ?></td>
